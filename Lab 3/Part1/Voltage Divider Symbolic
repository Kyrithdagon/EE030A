...
clear vS vR1 vR2 iS iR1 iR2 VS R1 R2; % clear symbolic variables

% ----- Declare symbolic variables and circuit parameters -------------
syms vS vR1 vR2 iS iR1 iR2; % unknown reference voltages & currents
syms VS R1 R2; % known circuit component parameters

% ----- Write KCL, KVL and, i-v equations -----------------------------
eq_node1 = iS + iR1 == 0; % KCL node 1
eq_node2 = -iR1 - iR2 == 0; % KCL node 2
...
S = solve(eq_node1,eq_node2,eq_loop1, ...
    eq_iv_VS,eq_iv_R1,eq_iv_R2, ...
    vS, vR1, vR2, iS, iR1, iR2 );
