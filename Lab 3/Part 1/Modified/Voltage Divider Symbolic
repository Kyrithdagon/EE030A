...
% ----- Declare symbolic variables and circuit parameters -------------
syms vS vR1 vR2 vR3 iS iR1 iR2 iR3; % unknown reference voltages & currents
syms VS R1 R2 R3; % known circuit component parameters

% ----- Write KCL, KVL and, i-v equations -----------------------------
eq_node1 = iR2 - iR1 - iR3 == 0; % KCL node 1
eq_node2 = iR3 - iS - iR2 == 0; % KCL node 2
eq_node3 = iS + iR1 == 0; % KCL node 3
eq_iv_VS = vS == VS; % i-v characteristic of the voltage src
eq_loop1 = -vS + vR1 + vR2 == 0; % KVL loop 1
eq_loop2 = -vR2 - vR3 == 0; % KVL loop 2
eq_loop3 = -vS + vR1 - vR3 == 0; % KVL loop 3
eq_iv_R1 = vR1 - R1*iR1 == 0; % i-v characteristic of R1
eq_iv_R2 = vR2 - R2*iR2 == 0; % i-v characteristic of R2
eq_iv_R3 = vR3 - R3*iR3 == 0; % i-v characteristic of R3

% ----- Solve symbolically the system of linear equations -------------
S = solve(eq_node1,eq_node2,eq_node3, ...
    eq_iv_VS,eq_loop1,eq_loop2,eq_loop3, ...
    eq_iv_R1,eq_iv_R2,eq_iv_R3, ...
    vS, vR1, vR2, vR3, iS, iR1, iR2, iR3);
